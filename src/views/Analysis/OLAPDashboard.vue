  ...
  <div class="dashboard-wrapper">
    <div class="graph-style-wrapper">
      ...
      <div class="graph-content-icons" v-if="expand">
        <div><el-button class="iconfont icon-line-chart" style="border: none;"  @click="setdata('line')"></el-button></div>
        <div><el-button class="iconfont icon-bar-chart" style="border: none;"  @click="setdata('bar')"></el-button> </div>
        <div><el-button class="iconfont icon-pie-chart" style="border: none;"  @click="setdata('pie')"></el-button> </div>
        <div><el-button class="iconfont icon-3D" style="border: none;"  @click="setdata('3D')"></el-button> </div>
        <div><el-button class="iconfont icon-map-chart" style="border: none;"  @click="setdata('map')"></el-button></div>
      </div>
    </div>
    <el-dialog title="数据源配置" :visible.sync="dialogVisible2" width="40%">
      <ul class="agrithm-config-ul">
        <li>
          ...
          <el-select name="select2" id="select2" ></el-select>
        </li>
        ...
        <li><div class="agrithm-config-title">经度范围：</div>
            <el-input class="input-left" v-model="tsscope.setlongitudeStart" /><span class="zhi">至</span>
            <el-input class="input-right" v-model="tsscope.setlongitudeEnd" /></li>
        <li><div class="agrithm-config-title">纬度范围：</div>
            <el-input class="input-left" v-model="tsscope.setlatitudeStart" /><span class="zhi">至</span>
            <el-input  class="input-right"  v-model="tsscope.setlatitudeEnd" /></li>
        <li><div class="agrithm-config-title">高度范围：</div>
            <el-input class="input-left" v-model="tsscope.setheightStart"/><span class="zhi">至</span>
            <el-input class="input-right" v-model="tsscope.setheightEnd"/></li>
    </ul>
  ...
  data () {
    return {
      ...
      tsscope: {
        ...
        heightStart: '5000m',
        heightEnd: '20000m',
        settimeStart: '2011-4-28-12',
        settimeEnd: '2011-4-28-14',
        setlongitudeStart: '108°E',
        setlongitudeEnd: '116°E',
        setlatitudeStart: '15°N',
        setlatitudeEnd: '23°N',
        setheightStart: '5000m',
        setheightEnd: '20000m'
      }
    }
  },
