const configs = {
  state: {
    atmosphereTheme: [
      {
        name: 'TPV',
        desc: '空七所提供的大气数据，描述了经度范围108°E~130°E、纬度范围15°N~25°N（0.1°方区）、高度范围500m~25000m（间隔500m）的温度、压强、三向风速数据'
      }, {
        name: 'NORTHSTANDARD',
        desc: '三院提供的北半球标准大气数据，模型拟合计算得出，描述了高度-2000m~80000m（间隔50m）的大气压强、密度、温度数据'
      }, {
        name: 'WINDFIELD',
        desc: '三院提供的大气风场数据，模型拟合计算得出，描述了纬度范围10°~70°、高度范围0m~25000m（间隔1000m）的大气风速U、风速V、实测风速、风速标准差、最大风速数据'
      }, {
        name: 'AT_WINDFIELD',
